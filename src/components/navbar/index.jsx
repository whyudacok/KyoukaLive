      ...
      <nav className=" ">
        <div className="w-[90%] md:w-[80%] m-auto flex justify-between items-center  md:h-[150px] py-6 md:py-2">
          <div className="logo md:flex items-center md:justify-evenly md:gap-5">
            <Link to="/">
              <h1 className="font-outfits md:text-4xl font-black text-3xl text-[#f07e5c]">
                kyouka
              </h1>
            </Link>
            <div className="menu hidden md:flex justify-evenly items-center w-[400px]">
              <a
                href="/this-season"
                className="text-white text-sm font-medium hover:text-[#f07e5c] duration-200"
              >
                This Season
              </a>
              <a
              ...
              {isLogin ? (
                <>
                  <a
                    href="/account"
                    className="text-white text-sm font-medium hover:text-[#f07e5c] duration-200  rounded-md"
                  >
                    Account
                  </a>
                  <button
                    onClick={handleLogOut}
                    className="text-white text-sm font-medium hover:text-[#f07e5c] duration-200 ring-1 ring-[#f07e5c] px-3 py-2 rounded-md"
                  >
                    Log-out
                  </button>
                </>
          ...
          >
            <input
              ...
              className="px-5 group-hover:pr-10 group-hover:w-[200px] md:duration-500 ring-1 outline-none text-sm py-2 group-hover:placeholder:text-slate-500 duration-500 text-gray-800 w-0 rounded-md"
