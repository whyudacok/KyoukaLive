  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sign up to your account on our platform and access exclusive features. Secure and convenient login process for a personalized experience. Join us today and enjoy the benefits of our service."
        />
        <title>Sign-up Kazuna Live - Streaming Anime Sub Indo</title>
          ...
          >
            ...
            <div className="confirmPassword flex flex-col gap-3">
              <label
                ...
                className="text-white  font-outfits "
              >
                Confirm Password{" "}
              </label>
              <input
