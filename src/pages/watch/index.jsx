...
const Watch = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Kazuna Live - Details {animeName}</title>
        <meta
          name="description"
          content={`Watch your favorite anime ${detailsWatch.title} with subtitles in Indonesian.`}
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content={`Kazuna Live - Watch Anime ${detailsWatch.title}`}
        />
        <meta
        ...
        <meta
          ...
          content="Kazuna your favorite anime with subtitles in Indonesian."
        />
        <meta
          name="twitter:image"
          content="https://raw.githubusercontent.com/LuckyIndraEfendi/KyoukaLive/main/public/logo.svg"
            ...
            <div className="aspectVideo mb-">
              <div className="mb-3">
                <video width="100%" poster={Thumbnail} controls>
                  {watching.episodeUrl &&
                    watching.episodeUrl.map((ress, i) => (
                      <source
                        src={ress.episode}
                        type={ress.type}
                        sizes={ress.size}
              ...
              <div className="px-3 py-3 flex  justify-between">
                <div className="episodeTitle">
                  <h1 className="text-white text-lg font-semibold font-outfits md:text-xl ">
                    {detailsWatch.title}
                  </h1>
                  <p className="font-karla text-sm md:text-base mt-2 font-light text-[#dbdcdd]">
                    Episode {epsId}
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 ">
                  ...
                  <div className="selectOption flex gap-1 justify-between w-full">
                    <div className="prev ">
                      {prevEpisodeId >= 1 && (
                        <a
                          href={`/watch/anime/${animeId}/${animeName}/episode/${prevEpisodeId}`}
                          className="bg-[#232329] rounded-md px-3 py-2 font-outfits text-sm font-medium text-slate-200"
                        >
                          Prev
                        </a>
                      )}
                    ...
                    <div className="next ">
                      {nextEpisodeId <= watching2.length && (
                        <a
                          href={`/watch/anime/${animeId}/${animeName}/episode/${nextEpisodeId}`}
                          className="bg-[#232329] text-sm rounded-md px-3 py-2 font-outfits font-medium text-slate-200"
                        >
                          Next
                        </a>
                      )}
            ...
            <div className="watchDetail">
              <div className="flex md:px-2 py-4 justify-between">
                <div className=" flex gap-5 items-center">
                  <img
                    src={detailsWatch.image}
                    alt=""
                    className="w-40 md:w-44 rounded-md"
                  />
                  <div className="flex flex-col gap-4 md:gap-6 ">
                    <div className="leading-8">
                      <h5 className="text-gray-400 font-roboto font-light md:text-base">
                        Studios
                      </h5>
                      <h1 className="text-slate-100 md:text-lg">
                        {detailsWatch.studio}
                      </h1>
                    </div>
              ...
              <div className="genre">
                <ul className="flex flex-wrap gap-4 mt-3">
                  {detailsWatch.genres.map((ress, i) => (
                    <li
                      className="ring-1 ring-[#f0683e] py-1 px-3 text-center  rounded-md text-white text-base"
                      key={i}
                    >
                      {ress}
                    </li>
              ...
              <div className="synopsis h-52 md:h-full overflow-y-scroll md:overflow-auto mt-10 bg-[#232329] px-6 py-5 rounded-md">
                <p className="text-white text-sm font-roboto md:text-[15px]  font-light">
                  {detailsWatch.synopsis}
                </p>
              </div>
            </div>
          </div>
